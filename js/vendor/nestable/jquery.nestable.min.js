...
e,!1),l.addEventListener("touchcancel",e,!1));a.el.on("mousedown",c);a.w.on("mousemove",b);a.w.on("mouseup",e)},serialize:function(){var a=this;step=function(c,b){var e=[];c.children(a.options.itemNodeName).each(function(){var d=g(this),f=g.extend({},d.data());d=d.children(a.options.listNodeName);d.length&&(f.children=step(d,b+1));e.push(f)});return e};return step(a.el.find(a.options.listNodeName).first(),0)},serialise:function(){return this.serialize()},asNestedSet:function(){function a(d,f,h){var m=

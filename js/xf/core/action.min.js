...
!1},250)})}},actionComplete:function(a){if(a.html){var b=this.$target,c=b.data("reaction-id"),d=a.reactionId,f=a.linkReactionId,g=this;XF.setupHtmlInsert(a.html,function(k,n,p){g.hide();n=k.find(".js-reaction");p=k.find(".js-reactionText");var t=b.find(".js-reaction"),r=b.find(".js-reactionText"),q=b.attr("href");f&&(q=q.replace(/(\?|&)reaction_id=\d+(?=&|$)/,"$1reaction_id="+f),b.attr("href",q));d?(b.addClass("has-reaction"),b.removeClass("reaction--imageHidden"),c&&b.removeClass("reaction--"+c),
b.addClass("reaction--"+d),b.data("reaction-id",d)):(b.removeClass("has-reaction"),b.addClass("reaction--imageHidden"),c&&(b.removeClass("reaction--"+c),b.addClass("reaction--"+k.data("reaction-id")),b.data("reaction-id",0)));t.replaceWith(n);r&&p&&r.replaceWith(p)});var h=this.options.reactionList?XF.findRelativeIf(this.options.reactionList,b):e([]);"undefined"!==typeof a.reactionList&&h.length&&(a.reactionList.content?XF.setupHtmlInsert(a.reactionList,function(k,n){h.html(k).addClassTransitioned("is-active")}):

...
{
	$__finalCompiled = '';
	$__finalCompiled .= '<p>We are ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ' ("we", "our", "us"). We’re committed to protecting and respecting your privacy. If you have questions about your personal information please <a href="' . $__templater->escape($__vars['xf']['contactUrl']) . '">contact us</a>.</p>
...
<p>We have a detailed cookie policy and more information about the cookies that we set on <a href="' . $__templater->func('link', array('help/cookies', ), true) . '">this page</a>.</p>

<h2>Rights</h2>
<p>You have a right to access the personal data we hold about you or obtain a copy of it. To do so please <a href="' . $__templater->escape($__vars['xf']['contactUrl']) . '">contact us</a>. If you believe that the information we hold for you is incomplete or inaccurate, you may <a href="' . $__templater->escape($__vars['xf']['contactUrl']) . '">contact us</a> to ask us to complete or correct that information.</p>
<p>You also have the right to request the erasure of your personal data. Please <a href="' . $__templater->escape($__vars['xf']['contactUrl']) . '">contact us</a> if you would like us to remove your personal data.</p>

...
' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' added you to an existing conversation at ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
<tr>
	<td>
		<a href="' . $__templater->func('link', array('canonical:conversations', $__vars['conversation'], ), true) . '" class="button">' . 'View this conversation' . '</a>
	</td>

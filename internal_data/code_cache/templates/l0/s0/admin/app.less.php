<?php
// FROM HASH: bf893395d1eb0ac2ecc8ba71b968bb75
return array(
...
@media (max-width: @xf-responsiveNarrow)
{
	.p-breadcrumbs
	{
		> li
		{
			...
			&:before
			{
				.m-faContent(@fa-var-chevron-left, false, ltr); // .72em
				.m-faContent(@fa-var-chevron-right, false, rtl); // .72em
				margin-right: .5em;
			}
		}
	}
...
.p-quickSearchResultList
{
	...
	a
	{
		...
		.p-quickSearchResult-extra
		{
			font-size: @xf-fontSizeSmaller;
			color: fade(@xf-textColorMuted, 75%);
		}

		.p-quickSearchResult-meta
		{
			font-size: @xf-fontSizeSmallest;
			color: @xf-textColorMuted;
			//text-align: right;

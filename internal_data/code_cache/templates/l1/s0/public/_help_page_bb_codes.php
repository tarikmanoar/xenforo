...
[EMAIL=example@example.com]Email me[/EMAIL]', array(array('preEscaped', array()),), false),
		...
		'example' => $__templater->filter('[USER=' . ($__vars['xf']['visitor']['user_id'] ? $__templater->escape($__vars['xf']['visitor']['user_id']) : '1') . ']' . 'Username' . '[/USER]', array(array('preEscaped', array()),), false),
		'anchor' => 'user-mention',
	), $__vars) . '

				...
				$__compilerTemp1 .= '
					...
					'explain' => '
								<ul class="listInline listInline--bullet">
									...
									<li>' . 'Content' . $__vars['xf']['language']['label_separator'] . ' ' . ($__templater->escape($__templater->method($__vars['xf']['app'], 'getContentTypePhrase', array($__vars['entry']['content_type'], ))) ?: $__templater->escape($__vars['entry']['content_type'])) . '</li>
								</ul>
							',
				), array()) . '
					';
